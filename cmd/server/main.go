...
func setupRouter() *gin.Engine {
	...
	protected.Use(middleware.AuthMiddleware())
	{
		...
		protected.POST("/financeiro/appypay/credenciais", handlers.CriarCredencialAppyPay)
		protected.PUT("/financeiro/appypay/credenciais/:id", handlers.AtualizarCredencialAppyPay)
		protected.GET("/financeiro/appypay/credenciais", handlers.ListarCredenciaisAppyPay)
		protected.GET("/financeiro/appypay/credenciais/:id", handlers.ObterCredencialAppyPay)
		protected.POST("/financeiro/appypay/credenciais/:id/testar", handlers.TestarCredencialAppyPay)
		protected.POST("/financeiro/appypay/credenciais/:id/ativar", handlers.AtivarCredencialAppyPay)
		protected.POST("/financeiro/appypay/credenciais/:id/desativar", handlers.DesativarCredencialAppyPay)
		protected.POST("/financeiro/modalidade-pagamento", handlers.AlterarModalidadePagamento)
