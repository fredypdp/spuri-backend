...
func setupRouter() *gin.Engine {
	...
	academia.Use(middleware.ValidarStatusAcademia())
	{
		...
		academia.POST("/estudante/:codigo/matricula/fundamental", handlers.EfetivarMatriculaFundamentalHandler)
		academia.POST("/estudante/:codigo/matricula/medio", handlers.EfetivarMatriculaMedioHandler)
		academia.POST("/estudante/:codigo/matricula/superior", handlers.EfetivarMatriculaSuperiorHandler)
		...
		academia.POST("/estudante/:codigo/arquivar", handlers.ArquivarEstudanteHandler)
		academia.POST("/estudante/:codigo/reativar", handlers.ReativarEstudanteHandler)
