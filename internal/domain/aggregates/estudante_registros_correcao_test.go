...
func TestCorrigirFaltaExigeMotivo(t *testing.T) {
	...
	if err := e.RegistrarFalta(academia, "2026", "7_ano_fundamental", data, materia, 1, nil, uuid.New()); err != nil {
		t.Fatal(err)
	}
	if err := e.CorrigirFalta(uuid.New(), academia, "2026", data, materia, 2, nil, "", uuid.New()); err == nil {
