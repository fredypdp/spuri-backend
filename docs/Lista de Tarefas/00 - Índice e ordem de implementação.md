...
| 17 | Implementar módulo base de gestão financeira com AppyPay para Spuri e academias | `17 - Modulo base de gestao financeira com AppyPay.md` | Reimplementação a partir do zero, depois de um rollback total motivado por três rondas de auditoria de segurança (ver tarefa 17 e `docs/Debbugs/`); deve incorporar as lições aprendidas desde o primeiro commit. |
